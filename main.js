...
const estudiante1 = new Estudiante("456789123", "Pedro", "Ramírez", "Soltero", "2º ESO");
...
// Ordenar las personas por apellidos
centroEducativo.ordenarPorApellidos();

// Imprimir la información de las personas ordenadas por apellidos
centroEducativo.imprimirInformacion();

// Filtrar las personas por tipo (estudiante)
const estudiantes = centroEducativo.filtrarPorTipo("estudiante");
console.log("Estudiantes:");
estudiantes.forEach(estudiante => {
    estudiante.imprimirInformacion();
});

// Buscar una persona por su ID/DNI
const personaEncontrada = centroEducativo.buscarPorDNI("654321987");
if (personaEncontrada) {
    console.log("Persona encontrada:");
    personaEncontrada.imprimirInformacion();
} else {
    console.log("No se encontró a ninguna persona con ese DNI");
}